...
import { BASE_URL, USER_API_URL, USER_INFO_KEY, LOCAL_STORAGE_KEYS } from '../../utils/constants';
...
export const LoginUserDetails = (data) => async (dispatch) => {
  ...
  postData(`${BASE_URL}${USER_API_URL}authenticate`, data).then(async (axiosResponse) => {
